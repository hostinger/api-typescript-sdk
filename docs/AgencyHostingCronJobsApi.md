...
|------------- | ------------- | -------------|
|[**createWebsiteCronJobV1**](#createwebsitecronjobv1) | **POST** /api/agency-hosting/v1/websites/{website_uid}/cron-jobs | Create website cron job|
|[**deleteWebsiteCronJobV1**](#deletewebsitecronjobv1) | **DELETE** /api/agency-hosting/v1/websites/{website_uid}/cron-jobs/{uuid} | Delete website cron job|
|[**listWebsiteCronJobsV1**](#listwebsitecronjobsv1) | **GET** /api/agency-hosting/v1/websites/{website_uid}/cron-jobs | List website cron jobs|

# **createWebsiteCronJobV1**
> AgencyHostingV1WebsitesCronJobsCronJobResource createWebsiteCronJobV1(agencyHostingV1WebsitesCronJobsCreateCronJobRequest)
...
const { status, data } = await apiInstance.createWebsiteCronJobV1(
    websiteUid,
    agencyHostingV1WebsitesCronJobsCreateCronJobRequest
);
```
...
> CommonSuccessEmptyResource deleteWebsiteCronJobV1()
...
const { status, data } = await apiInstance.deleteWebsiteCronJobV1(
    websiteUid,
    uuid
);
```
...
> AgencyHostingListWebsiteCronJobsV1200Response listWebsiteCronJobsV1()
...
const { status, data } = await apiInstance.listWebsiteCronJobsV1(
    websiteUid,
    page,
    perPage
);
