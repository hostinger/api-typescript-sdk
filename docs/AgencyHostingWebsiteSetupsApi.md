...
|------------- | ------------- | -------------|
|[**createANewWebsiteV1**](#createanewwebsitev1) | **POST** /api/agency-hosting/v1/orders/{order_id}/websites/setups | Create a new website|
|[**getWebsiteSetupStatusV1**](#getwebsitesetupstatusv1) | **GET** /api/agency-hosting/v1/orders/{order_id}/websites/setups/{setup_uuid} | Get website setup status|

# **createANewWebsiteV1**
> AgencyHostingV1SetupsWebsiteSetupResource createANewWebsiteV1(agencyHostingV1SetupsCreateSetupRequest)
...
const { status, data } = await apiInstance.createANewWebsiteV1(
    orderId,
    agencyHostingV1SetupsCreateSetupRequest
);
```
...
> AgencyHostingV1SetupsWebsiteSetupStatusResource getWebsiteSetupStatusV1()
...
const { status, data } = await apiInstance.getWebsiteSetupStatusV1(
    orderId,
    setupUuid
);
```
