...
**is_preselected** | **boolean** | Whether the plugin is preselected during onboarding | [optional] [default to undefined]
...
```typescript
import { WordPressV1PluginsSuggestedPluginResource } from 'hostinger-api-sdk';

const instance: WordPressV1PluginsSuggestedPluginResource = {
    slug,
    title,
    description,
