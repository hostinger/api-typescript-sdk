...
|------------- | ------------- | -------------|
|[**listAvailableDatacentersV1**](#listavailabledatacentersv1) | **GET** /api/agency-hosting/v1/orders/{order_id}/datacenters | List available datacenters|

# **listAvailableDatacentersV1**
> Array<AgencyHostingV1DatacentersDatacenterResource> listAvailableDatacentersV1()
