 ...
 * 
 * @export
 * @interface DNSV1ZoneNameResource
 */
export interface DNSV1ZoneNameResource {
    /**
     * Name of the record (use `@` for wildcard name)
     * @type {string}
     * @memberof DNSV1ZoneNameResource
     */
    'name'?: string;
    /**
     ...
     * @memberof DNSV1ZoneNameResource
     */
    'type'?: DNSV1ZoneNameResourceTypeEnum;
}

export const DNSV1ZoneNameResourceTypeEnum = {
    A: 'A',
    Aaaa: 'AAAA',
    Cname: 'CNAME',
    Alias: 'ALIAS',
...
export type DNSV1ZoneNameResourceTypeEnum = typeof DNSV1ZoneNameResourceTypeEnum[keyof typeof DNSV1ZoneNameResourceTypeEnum];
...
export const DNSZoneApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getRecordsV1(domain: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<DNSV1ZoneNameResource>>> {
...
export const DNSZoneApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getRecordsV1(domain: string, options?: RawAxiosRequestConfig): AxiosPromise<Array<DNSV1ZoneNameResource>> {
...
export const VPSVirtualMachineApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @summary Get metrics
         * @param {number} virtualMachineId Virtual Machine ID
         * @param {string} dateFrom the date-time notation as defined by RFC 3339, section 5.6
         * @param {string} dateTo the date-time notation as defined by RFC 3339, section 5.6
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
