...
export const ReachContactsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createANewContactV1(reachV1ContactsStoreRequest: ReachV1ContactsStoreRequest, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ReachV1ContactsContactResource>> {
...
export const ReachContactsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createANewContactV1(reachV1ContactsStoreRequest: ReachV1ContactsStoreRequest, options?: RawAxiosRequestConfig): AxiosPromise<ReachV1ContactsContactResource> {
